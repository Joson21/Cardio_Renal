...
class KidneyModel:
    ...
    def __init__(
        ...
        self._raw_v_md_reference = raw_md_renin_feedback(
            reference["phi_md_sodium_mEq_per_min"], self.p
        )
        self._raw_v_rsna_reference = raw_rsna_renin_feedback(reference["rsna"])
        self._raw_v_at1_reference = at1_renin_feedback(
            reference["at1_bound_pg_per_mL"], self.p
        )
